...
class Language extends ChangeNotifier {
  ...
  static Map<String, Object?> ar = {
    ...
    "bestlinedesc":
        "أفضل مسار هي ميزة تمكنك من معرفة أفضل طريقة لزيارة جميع عملائك في أقصر مسافة وأسرع وقت، لذا يجب عليك زيارة عملائك بالترتيب بدءاً من العميل رقم واحد.",
    "Total": "  المجموع  ",
    "Add": "إضافة",
    "delete": "حذف",
  ...
  static Map<String, Object?> en = {
    ...
    "Supplydocument":"Supply document",
    "unit": "unit",
    "Inventoryid": "Inventory number",
    "updatescreen": "Updating data",
    ...
    "bestlinedesc":
        "Best Path is a feature that enables you to know the best way to visit all your customers in the shortest distance and fastest time, so you should visit your customers in order starting from customer number one.",
