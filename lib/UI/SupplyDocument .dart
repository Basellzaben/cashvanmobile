...
import '../Models/Supply_D_Model.dart';
import '../Models/Supply_H_Model.dart';
...
class SupplyDocument extends StatefulWidget {
  @override
  State<SupplyDocument> createState() => _SupplyDocument();
}

class _SupplyDocument extends State<SupplyDocument> {
  String CustomerId = '';
  String CustomerName = '';
  ...
  Future<int> GetMax() async {
    max = await GettAllData.GetMaxSupply(context);
  ...
  List<Supply_D_Model>? cartToPost_D = [];
  List<Supply_H_Model>? cartToPost_H = [];
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          ...
                          onTap: () {
                            ...
                            var ItemOrgPrice;
                            if (!IncludeTex) {
                              bouncetotal += double.parse(
                                  myObjects[index].bounce.toString());
