...
margin: EdgeInsets.only(top: 0),
  ...
  Future<List<UsersModel>> Login(
      String username,String passwor
      ) async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        StoreShared.SaveJson(Globalvireables.UsersJson, res.body);
      ...
      print("SHARED  + "+await StoreShared.getJson(Globalvireables.UsersJson));
      ...
      if(await StoreShared.checkNetwork()){
        ...
        List<dynamic> body = jsonDecode(await StoreShared.getJson(Globalvireables.UsersJson));
